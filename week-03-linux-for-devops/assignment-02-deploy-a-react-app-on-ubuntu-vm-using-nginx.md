...
![Screenshot 1](screenshots/npm_node.png)
...
![Screenshot](screenshots/Nginx_service.png)
...
![Screenshot 3](screenshots/React_repo.png)
...
![Screenshot 4](screenshots/Full_name.png)
...
![Screenshot 5](screenshots/Build_folder.png)
...
![Screenshot 6](screenshots/webroot.png)
...
![Screenshot 7](screenshots/systemctl-is-active.png)

---

#### Screenshot 8 — Output of `cat /etc/nginx/sites-available/default` showing the Nginx config

![Screenshot 8](screenshots/cat.png)
...
![Screenshot 9](screenshots/Curl_output.png)

---

#### Screenshot 10 — Browser showing the deployed React app at `http://<public-ip>` with your name and date visible

![Screenshot 10](screenshots/react_up.png)
...
https://www.linkedin.com/posts/ayomikunphilip_dmibypravinmishra-agenticai-devops-share-7482820934286950400-WU1W/?utm_source=social_share_send&utm_medium=member_desktop_web&rcm=ACoAAF4cLMMBGj_ND3_b5bGU28ywvq8aZAW62fs

---

#### Screenshot — LinkedIn post showing the deployed application

![Screenshot](screenshots/LinkedIn_ASS02.png)
